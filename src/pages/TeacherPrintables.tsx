...
const TeacherPrintables = () => {
  return (
    <>
      <Helmet>
        <title>
          Free Tooth Fairy SEL Printables for Grades 1–2 | Wiggly Tooth Workshop
        </title>
        <meta
          name="description"
          content="Free Tooth Fairy worksheets, coloring pages, and SEL classroom activities for first and second grade students. Help children reflect on kindness, bravery, persistence, creativity, and growth through a magical Tooth Fairy tradition."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="Free Tooth Fairy SEL Printables for Grades 1–2 | Wiggly Tooth Workshop"
        />
        <meta
          property="og:description"
          content="Free Tooth Fairy worksheets, a coloring page, and a teacher guide for first and second grade. Help children reflect on kindness, bravery, creativity, and persistence — through the magic of losing a tooth."
        />
        <meta
          property="og:url"
        ...
        <meta
          ...
          content="Free Tooth Fairy worksheets, coloring page, and teacher guide for first and second grade. A simple SEL activity built around losing a tooth. No sign-up required."
        />
            ...
            "@graph": [
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 2,
                    "name": "Free Tooth Fairy SEL Printables for Grades 1–2",
              ...
              },
              {
                "@type": "ItemList",
                "name": "Free Tooth Fairy SEL Printables for Grades 1–2",
                "description": "A free SEL activity bundle for grades 1–2 built around the Tooth Fairy tradition. Includes a student worksheet, teacher guide, and coloring page. Supports social-emotional learning, self-reflection, and positive identity-building.",
                "numberOfItems": 3,
                "itemListElement": [
                  {
                    "@type": "ListItem",
                    ...
                    "item": {
                      ...
                      "name": "Tooth Fairy SEL Worksheet for Kids — The Good Things You Grow",
                      "description": "A free printable SEL reflection worksheet for grades 1–2 where children identify qualities they have been growing: kindness, bravery, creativity, patience, persistence.",
                  ...
                  },
                  {
                    ...
                    "item": {
                      ...
                      "description": "A free tooth fairy teacher guide with a 15–20 minute SEL lesson plan for grades 1–2. Includes discussion prompts, CASEL-aligned learning goals, and a repeatable classroom tradition.",
                      "encodingFormat": "application/pdf",
                ...
                "mainEntity": [
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "SEL stands for social-emotional learning. In early elementary classrooms, SEL helps children recognize feelings, name positive qualities, build empathy, and understand how their actions affect others."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "How does losing a tooth connect to SEL?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Losing a tooth is a familiar milestone for first and second graders. This activity uses that moment to help children reflect on kindness, bravery, effort, creativity, and persistence — the small actions that help them grow."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What grade level are these Tooth Fairy printables for?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "These printables are designed for first and second grade students — the age when most children are actively losing teeth and when SEL concepts like self-reflection and naming positive qualities are developmentally appropriate. Kindergarten and third grade teachers often find them useful too."
                    }
                  },
                  {
                    "@type": "Question",
                  ...
                  },
                  {
                    ...
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Absolutely. These were designed with classroom use in mind. The teacher guide includes a full lesson plan, discussion prompts, and instructions for turning the activity into a repeatable SEL tradition every time a student loses a tooth."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Can parents use these Tooth Fairy printables at home?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes. The worksheet and coloring page work well at home when a child loses a tooth. The teacher guide includes notes on involving families, and the worksheet is designed to be kept."
                    }
                  },
                  {
                    "@type": "Question",
