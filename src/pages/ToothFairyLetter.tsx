...
const ToothFairyLetter = () => {
  return (
    <>
      <Helmet>
        <title>Free Printable Tooth Fairy Letter Template | Wiggly Tooth Workshop</title>
        <meta
          name="description"
          content="Download a free printable Tooth Fairy letter template that celebrates your child's lost tooth, their special qualities, and the magic they help bring into the world."
        />
        <link rel="canonical" href="https://wigglytoothworkshop.com/tooth-fairy-letter" />
        <meta
          property="og:title"
          content="Free Printable Tooth Fairy Letter Template | Wiggly Tooth Workshop"
        />
        <meta
          property="og:description"
          content="A free, personalised letter from the Tooth Fairy. Celebrates your child's lost tooth and the special quality that was growing inside it. Download the PDF or image version."
        />
        <meta property="og:url" content="https://wigglytoothworkshop.com/tooth-fairy-letter" />
        ...
        <meta
          ...
          content="A free, personalised Tooth Fairy letter template for parents. Download PDF or image. Fill in your child's name and the special quality their tooth held."
        />
            ...
            "@graph": [
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    "@type": "ListItem",
                    "position": 2,
                    "name": "Free Printable Tooth Fairy Letter Template",
                    "item": "https://wigglytoothworkshop.com/tooth-fairy-letter"
                  }
                ]
              },
              {
                ...
                "name": "Free Printable Tooth Fairy Letter Template",
                "description": "A free personalised Tooth Fairy letter template for parents. Celebrates the child's lost tooth and the special quality — courage, kindness, creativity, patience — that was growing inside it.",
                "encodingFormat": "application/pdf",
                "url": "https://wigglytoothworkshop.com/downloads/tooth-fairy-letter-template.pdf",
              ...
              },
              {
                ...
                "mainEntity": [
                  {
                    "@type": "Question",
                    "name": "What should a Tooth Fairy letter say?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "A good Tooth Fairy letter thanks the child for the tooth, mentions something special about them, and keeps the magic alive. This template adds one extra idea: the tooth held a special quality that helped the Tooth Fairy make the world a little better."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Can I personalise this Tooth Fairy letter?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes. The template has blanks for your child's name, their special quality (like courage or kindness), how that quality has been growing, and what the Tooth Fairy did with the magic from the tooth."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Should the Tooth Fairy leave money with the letter?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Many families do. In this version, the money is a thank-you, not a payment. The letter frames it that way: the money is left because the tooth mattered, because of the qualities it held."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "What age is this Tooth Fairy letter best for?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "This works especially well for children around ages 5–8, when losing teeth still feels magical and the ideas of courage, kindness, and curiosity are just starting to become meaningful."
                    }
                  },
                  {
                    "@type": "Question",
                    "name": "Can teachers use this Tooth Fairy letter?",
                    "acceptedAnswer": {
                      "@type": "Answer",
                      "text": "Yes. Teachers can use the letter idea alongside the free Tooth Fairy worksheet and teacher guide to create a small classroom tradition around lost teeth. Each time a student loses a tooth, the letter and worksheet together make the moment feel significant."
                    }
                  }
                ]
              }
